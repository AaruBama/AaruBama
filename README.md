...
- **Crypto Claude** - Using Claude for Momentum trading and keeping eye on crypto market for early trends.
- **GEMINI Video Gen** - Using GCP and only Google tools to create production quality ads for SMBs.
